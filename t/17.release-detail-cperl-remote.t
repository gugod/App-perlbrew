...
my $rd = { type => "cperl", "version" => "5.27.0" };
$app->release_detail_cperl_remote("cperl-5.27.0", $rd);

ok defined( $rd->{tarball_url} );
ok defined( $rd->{tarball_name} );

is $rd->{tarball_url}, "https://github.com/perl11/cperl/archive/cperl-5.27.0.tar.gz";
is $rd->{tarball_name}, "cperl-5.27.0.tar.gz";
