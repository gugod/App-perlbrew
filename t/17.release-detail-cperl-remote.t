...
$app->release_detail_cperl_remote("cperl-5.24.2", $rd);

ok defined( $rd->{tarball_url} );
ok defined( $rd->{tarball_name} );

is $rd->{tarball_url}, "https://github.com/perl11/cperl/releases/download/cperl-5.24.2/cperl-5.24.2.tar.gz";
is $rd->{tarball_name}, "cperl-5.24.2.tar.gz";
